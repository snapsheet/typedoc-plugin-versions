...
export declare type version = `v${string}`;
/**
 ...
 */
export declare type validLocation = 'body.begin' | 'body.end' | 'content.begin' | 'content.end' | 'navigation.begin' | 'navigation.end';
export declare type semanticAlias = 'stable' | 'dev';
